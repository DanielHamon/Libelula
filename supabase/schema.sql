...
ALTER FUNCTION "public"."prevalidar_token_anonimo"("p_token" "text", "p_red_hash" "text", "p_dispositivo_hash" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."intentos_token_anonimos" (
    ...
    "intentado_en" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "intentos_token_anonimos_red_hash_check" CHECK (("red_hash" ~ '^[0-9a-f]{64}$'::"text")),
    CONSTRAINT "intentos_token_anonimos_dispositivo_hash_check" CHECK (("dispositivo_hash" ~ '^[0-9a-f]{64}$'::"text"))
);


ALTER TABLE "public"."intentos_token_anonimos" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tokens" (
    ...
    CONSTRAINT "token_valido_formato_seguro" CHECK ((("estado" <> 'valido'::"text") OR ("id" ~ '^[0-9A-HJKMNP-TV-Z]{10}$'::"text") OR ("id" ~ '^(TL|TD)-[0-9A-F]{32}$'::"text"))),
...
CREATE INDEX "idx_intentos_token_anonimos_red_hora" ON "public"."intentos_token_anonimos" USING "btree" ("red_hash", "intentado_en");


CREATE INDEX "idx_intentos_token_anonimos_dispositivo_hora" ON "public"."intentos_token_anonimos" USING "btree" ("dispositivo_hash", "intentado_en");


CREATE INDEX "idx_intentos_token_anonimos_limpieza" ON "public"."intentos_token_anonimos" USING "btree" ("intentado_en");
...
REVOKE ALL ON FUNCTION "public"."generar_token_10"() FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."generar_token_10"() TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."prevalidar_token_anonimo"("p_token" "text", "p_red_hash" "text", "p_dispositivo_hash" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."prevalidar_token_anonimo"("p_token" "text", "p_red_hash" "text", "p_dispositivo_hash" "text") TO "service_role";
